...
router.post('/', requireAuth, async (req, res) => {
  ...
  const SYNTH_MODE_INSTRUCTIONS = {
    ...
    'action-plan':   'OUTPUT FORMAT: Numbered action steps ONLY. Begin immediately with step 1 — no title, no introduction, no headers, no prose paragraphs, no bullet points. Use exactly this format:\n1. [Specific action]\n2. [Specific action]\n3. [Specific action]\nEach step must start with an active verb. Minimum 5 steps, maximum 10. Focus entirely on WHAT TO DO, sequenced logically. Any deviation from this format is a failure.',
