...
router.post('/', requireAuth, async (req, res) => {
  ...
  const SYNTH_MODE_INSTRUCTIONS = {
    ...
    'custom':        req.body.customInstruction
      ? 'CUSTOM QUESTION — the user wants you to answer a specific question using the AI responses as your source material. Ignore the original prompt framing entirely. Focus exclusively on answering this: ' + req.body.customInstruction + ' — Use the AI responses as evidence and context. Be direct and specific. If the responses do not contain enough information to answer this question, say so clearly.'
      : 'CUSTOM SYNTHESIS INSTRUCTION — the user selected custom format but did not provide specific instructions. Ask them: "What would you like to know? For example: salary range, key risks, next steps, etc."',
  };
