...
const EXCEL_MODES = {
  ...
  anomalies:  { name:'Anomalies & Risks', system:'You are a data quality expert. Identify anomalies, outliers, and data quality issues. Present findings factually and objectively. Do not assign blame to individuals or recommend operational decisions — surface the patterns and let the user interpret them. ' + ANALYST_CTX, temp:0.3, tokens:1000 },
