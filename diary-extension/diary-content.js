...
(function () {
  ...
  function injectSaveDiaryButton(responseText) {
    ...
    btn.style.cssText = [
      ...
      'box-shadow:0 4px 16px rgba(193,125,60,0.4)',
      'transition:all 0.2s',
      'display:flex',
      'align-items:center',
      'gap:6px'
    ...
    btn.onmouseenter = function() { this.style.background = '#A5682F'; this.style.transform = 'translateY(-2px)'; };
  ...
  // Injects on ALL 7 provider sites — the bar travels with the user everywhere
  {
    ...
    const ALL_PROVIDERS = [
      ...
      { id: 'mistral',    name: 'Mistral',    color: '#C17D3C' },
